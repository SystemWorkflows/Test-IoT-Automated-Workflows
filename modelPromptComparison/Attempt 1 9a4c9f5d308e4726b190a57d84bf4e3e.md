...
Notes/Explanation: Prompts too long
...
The Node-RED workflow produced when implementing the system based on the syste proposal, using the Things/devices provided:
[
    {
        "id": "c348ea29f9cebfd1",
        "type": "tab",
